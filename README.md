Simple non-dangerous oracle database activity monitoring shell script. Query and sessions tuning, different parameters, objects properties, ddl extract, trace, AWR, SPM and much more.
