...
lock [lib | obj OBJECT_NAME | distrib [commit TRX | rollback TRX | purge TRX (for collecting,prepared) | hardpurge TRX | hardpurge-ORA-02075-prepared TRX ] ] - blocking locks information, lib - library lock information
