...
host:db:set=beta:aisutf:mon_diskspace.sh:mon_swap.sh:mon_tbs.sh:mon_ping_ssh.sh
host:db:set=gw:%:mon_diskspace.sh:mon_swap.sh:mon_ping_ssh.sh
...
# % - mask send mail for all host or db or scripts. may be many lines of host:db:set
# host:db:set=%:%:%
host:db:set=aisprod:aisutf:mon_db.sh:mon_diskspace.sh:mon_ping_ssh.sh:mon_processes_sessions.sh:mon_tbs.sh
#host:db:set=%:aisutf:%
